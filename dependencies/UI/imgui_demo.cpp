...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (!ImGui::Begin("IrisEngine Test Layer", p_open, window_flags))
    {
    ...
    ImGui::Text("IrisEngine says hello. (% s)", IMGUI_VERSION);
    ImGui::Spacing();

    IMGUI_DEMO_MARKER("Help");
    if (ImGui::CollapsingHeader("Help"))
    {
        ImGui::Text("ABOUT IRIS ENGINE TEST LAYER :");
        ImGui::BulletText("Sections below are demonstrating many aspects of the engine's library.");
        ImGui::BulletText("The \"Examples\" menu above leads to more demo contents.");
        ImGui::BulletText("The \"Tools\" menu above gives access to: About Box, Style Editor,\n"
                          "and Metrics/Debugger (general purpose  debugging tool).");
        ImGui::Separator();
